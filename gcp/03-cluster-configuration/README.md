[![Deploy](https://get.pulumi.com/new/button.svg)](https://app.pulumi.com/new?template=https://github.com/pulumi/kubernetes-guides/blob/master/gcp/03-cluster-configuration/README.md)
...
1.  Collect any stack configuration references to configure the stack in the
    ...
    ```bash
    user@pulumi:~/pulumi/kubernetes-guides/gcp/01-identity$ pul stack ls
